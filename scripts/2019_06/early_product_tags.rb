...
good_intentions_3_autorenew = 2418358190138
...
# june_collection: Off the Track
off_track_3 = 2405032362042
off_track_5 = 2405032820794
off_track_3_autorenew = 2418378244154
off_track_5_autorenew = 2418380898362
# set current tags
ProductTag.create_with(early_tag).find_or_create_by(product_id: off_track_3, tag: 'current').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: off_track_5, tag: 'current').update(early_tag)
...
# set skippable tags
ProductTag.create_with(early_tag).find_or_create_by(product_id: off_track_3, tag: 'skippable').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: off_track_5, tag: 'skippable').update(early_tag)
...
# set switchable tags
ProductTag.create_with(early_tag).find_or_create_by(product_id: off_track_3, tag: 'switchable').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: off_track_5, tag: 'switchable').update(early_tag)
...
# delete from product_tags where product_id in ('2339789013050','2339790127162','2343841792058','2343842807866','2339796320314','2339797532730','2342557843514','2342559973434');
