...
#Street Smarts2
street_smarts2_3 = 2188530778170
street_smarts2_5 = 2188532875322
street_smarts2_auto_3 = 2196272807994
street_smarts2_auto_5 = 2188543328314

ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_3, tag: 'current').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_5, tag: 'current').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_3, tag: 'skippable').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_5, tag: 'skippable').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_3, tag: 'switchable').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_5, tag: 'switchable').update(early_tag)

ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_auto_3, tag: 'current').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_auto_5, tag: 'current').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_auto_3, tag: 'skippable').update(early_tag)
ProductTag.create_with(early_tag).find_or_create_by(product_id: street_smarts2_auto_5, tag: 'skippable').update(early_tag)
