...
module DetermineInfo
  class InfoGetter
    ...
    def load_switchable_products
        ...
        @conn.prepare('statement1', "#{my_insert}")
        CSV.foreach('mar2019_switchable_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
          #puts row.inspect
    ...
    def load_matching_products
      ...
      @conn.prepare('statement1', "#{my_insert}")
      CSV.foreach('mar2019_matching_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        #puts row.inspect
    ...
    def load_alternate_products
      ...
      @conn.prepare('statement1', "#{my_insert}")
      CSV.foreach('mar2019_alternate_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        #puts row.inspect
