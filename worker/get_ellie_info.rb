...
module DetermineInfo
  class InfoGetter
    ...
    def load_skippable_products
        ...
        @conn.prepare('statement1', "#{my_insert}")
        CSV.foreach('staging_october2018_skippable_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
          #puts row.inspect
    ...
    def load_matching_products
      ...
      @conn.prepare('statement1', "#{my_insert}")
      CSV.foreach('staging_october2018_matching_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        #puts row.inspect
    ...
    def load_alternate_products
      ...
      @conn.prepare('statement1', "#{my_insert}")
      CSV.foreach('staging_october2018_alternate_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        #puts row.inspect
