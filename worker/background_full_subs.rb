...
module FullBackgroundSubs
    ...
    def get_all_subs(params)
        ...
        #TODO (Neville): changed url to active subs
        ...
        1.upto(num_pages) do |page|
          #TODO (Neville): changed url to active subs
          mysubs = HTTParty.get("https://api.rechargeapps.com/subscriptions?limit=250&page=#{page}&status=ACTIVE", :headers => my_header)
          #puts mysubs.inspect
